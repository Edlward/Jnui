...
QT_MOC_LITERAL(1, 13, 10), // "DataReady2"
QT_MOC_LITERAL(2, 24, 0) // ""

    },
    "DataReceiver\0DataReady2\0"
};
...
void DataReceiver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DataReceiver::DataReady2)) {
                *result = 0;
                return;
            }
        }
